...
public final class MetadataReader
{
    ...
    {
        org.apache.parquet.column.statistics.Statistics<?> columnStatistics = new ParquetMetadataConverter().fromParquetStatistics(null, statistics, type);

        if ((type == PrimitiveTypeName.FIXED_LEN_BYTE_ARRAY || type == PrimitiveTypeName.BINARY)
                && statistics != null
                ...
                && !CorruptStatistics.shouldIgnoreStatistics(null, type)) {
